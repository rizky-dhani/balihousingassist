    ...
    <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
      <div>
        ...
        <p class="mt-4 max-w-xs text-gray-500">
          Your trusted partner for finding the perfect stay in Bali.
        </p>

        <ul class="mt-8 flex gap-6">
          @if ($siteSettings?->facebook_url)
          <li>
            <a href="{{ $siteSettings->facebook_url }}" rel="noreferrer" target="_blank" class="text-gray-700 transition hover:opacity-75">
          ...
          <li>
            <a href="{{ $siteSettings->instagram_url }}" rel="noreferrer" target="_blank" class="text-gray-700 transition hover:opacity-75">
          ...
          <li>
            <a href="{{ $siteSettings->twitter_url }}" rel="noreferrer" target="_blank" class="text-gray-700 transition hover:opacity-75">
          ...
          <li>
            <a href="{{ $siteSettings->linkedin_url }}" rel="noreferrer" target="_blank" class="text-gray-700 transition hover:opacity-75">
