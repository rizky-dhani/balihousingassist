...
<div class="block rounded-lg p-4 shadow-sm border border-base-200 bg-base-100 transition-all hover:shadow-lg">
  ...
  <div class="mt-2">
    ...
    <div class="mt-4">
        <a href="https://wa.me/628123456789?text={{ urlencode("Hello, I'm interested in booking " . $property->name . " in " . $property->location . ". Can I get more details?") }}" target="_blank" class="btn btn-primary btn-sm w-full font-bold">
